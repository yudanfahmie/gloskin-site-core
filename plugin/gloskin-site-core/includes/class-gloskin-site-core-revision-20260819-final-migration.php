...
final class Gloskin_Site_Core_Revision_20260819_Final_Migration {
	...
	private function run_demo_seed() {
		...
		/*
		 * Realistic demo seed data (r2 — 0.7.153).
		 * Identity keys use the -r2 prefix; posts remain 'draft' per
		 * engineering-fixture policy. Use Admin > Reset Demo to create
		 * the published+active presentation versions on staging.
		 */
		$seeds = array(
			/* Promos */
			array( 'type' => 'promo', 'post_type' => Gloskin_Site_Core_Content_Service::PROMO_POST_TYPE, 'identity' => 'gloskin-demo-r2-promo-brightening', 'title' => 'Paket Brightening Intensif', 'excerpt' => 'Kombinasi eksfoliasi enzimatik, infus vitamin C, dan LED photo-therapy untuk kulit cerah merata dalam 4 sesi.', 'meta' => array( 'gloskin_promo_eyebrow' => 'Promo Bulan Ini', 'gloskin_promo_summary' => 'Kombinasi eksfoliasi enzimatik, infus vitamin C, dan LED photo-therapy untuk kulit cerah merata dalam 4 sesi.', 'gloskin_promo_cta_label' => 'Cek Paket', 'gloskin_promo_cta_url' => '/treatments/', 'gloskin_promo_active' => '0', 'gloskin_promo_order' => '1' ) ),
			array( 'type' => 'promo', 'post_type' => Gloskin_Site_Core_Content_Service::PROMO_POST_TYPE, 'identity' => 'gloskin-demo-r2-promo-konsultasi-gratis', 'title' => 'Konsultasi Perdana Bebas Biaya', 'excerpt' => 'Periksa kondisi kulit bersama dokter spesialis dan dapatkan rekomendasi perawatan personal tanpa biaya untuk kunjungan pertama.', 'meta' => array( 'gloskin_promo_eyebrow' => 'Penawaran Pasien Baru', 'gloskin_promo_summary' => 'Periksa kondisi kulit bersama dokter spesialis dan dapatkan rekomendasi perawatan personal tanpa biaya untuk kunjungan pertama.', 'gloskin_promo_cta_label' => 'Daftar Sekarang', 'gloskin_promo_cta_url' => '/treatments/', 'gloskin_promo_active' => '0', 'gloskin_promo_order' => '2' ) ),
			array( 'type' => 'promo', 'post_type' => Gloskin_Site_Core_Content_Service::PROMO_POST_TYPE, 'identity' => 'gloskin-demo-r2-promo-acne-program', 'title' => 'Acne Clear Program — 6 Minggu', 'excerpt' => 'Program terintegrasi: chemical peel, microneedling, dan homecare regimen selama 6 minggu untuk kulit bebas jerawat aktif.', 'meta' => array( 'gloskin_promo_eyebrow' => 'Program Unggulan', 'gloskin_promo_summary' => 'Program terintegrasi: chemical peel, microneedling, dan homecare regimen selama 6 minggu untuk kulit bebas jerawat aktif.', 'gloskin_promo_cta_label' => 'Lihat Program', 'gloskin_promo_cta_url' => '/treatments/', 'gloskin_promo_active' => '0', 'gloskin_promo_order' => '3' ) ),
			/* Testimonials */
			array( 'type' => 'testimonial', 'post_type' => Gloskin_Site_Core_Content_Service::TESTIMONIAL_POST_TYPE, 'identity' => 'gloskin-demo-r2-testi-anisa', 'title' => 'Jerawat aktif tuntas dalam 2 bulan', 'excerpt' => 'Sudah 3 tahun saya coba berbagai produk tapi jerawat selalu kembali. Di Gloskin baru 2 bulan dan hasilnya benar-benar berbeda — kulit saya bersih dan jauh lebih sehat.', 'meta' => array( 'gloskin_testimonial_attribution' => 'Anisa R., 26 tahun', 'gloskin_testimonial_subtitle' => 'Perawatan Acne & Scarring', 'gloskin_testimonial_active' => '0', 'gloskin_testimonial_order' => '1' ) ),
			array( 'type' => 'testimonial', 'post_type' => Gloskin_Site_Core_Content_Service::TESTIMONIAL_POST_TYPE, 'identity' => 'gloskin-demo-r2-testi-dewi', 'title' => 'Flek berkurang, kulit terlihat lebih muda', 'excerpt' => 'Kulit saya sensitif, tapi dokternya sabar menjelaskan setiap langkah. Flek di pipi sudah jauh berkurang dan banyak teman yang tanya saya pakai apa.', 'meta' => array( 'gloskin_testimonial_attribution' => 'Dewi K., 34 tahun', 'gloskin_testimonial_subtitle' => 'Perawatan Brightening', 'gloskin_testimonial_active' => '0', 'gloskin_testimonial_order' => '2' ) ),
			array( 'type' => 'testimonial', 'post_type' => Gloskin_Site_Core_Content_Service::TESTIMONIAL_POST_TYPE, 'identity' => 'gloskin-demo-r2-testi-bima', 'title' => 'Klinik yang jujur dan tidak memaksa', 'excerpt' => 'Yang saya suka dari Gloskin adalah dokternya tidak langsung menawarkan treatment mahal. Saya dikasih tahu kondisi kulit dulu, baru diberi rekomendasi yang sesuai kebutuhan.', 'meta' => array( 'gloskin_testimonial_attribution' => 'Bima S., 29 tahun', 'gloskin_testimonial_subtitle' => 'Konsultasi Kulit', 'gloskin_testimonial_active' => '0', 'gloskin_testimonial_order' => '3' ) ),
			/* Achievements */
			array( 'type' => 'achievement', 'post_type' => Gloskin_Site_Core_Content_Service::ACHIEVEMENT_POST_TYPE, 'identity' => 'gloskin-demo-r2-achiev-hba-2024', 'title' => 'Klinik Kulit Terbaik Bandung 2024', 'excerpt' => 'Penghargaan atas komitmen pelayanan dermatologi dan estetika berkualitas tinggi di wilayah Bandung.', 'meta' => array( 'gloskin_achievement_issuer' => 'Health & Beauty Awards Indonesia', 'gloskin_achievement_year' => '2024', 'gloskin_achievement_feature_on_home' => '1', 'gloskin_achievement_active' => '0', 'gloskin_achievement_order' => '1' ) ),
			array( 'type' => 'achievement', 'post_type' => Gloskin_Site_Core_Content_Service::ACHIEVEMENT_POST_TYPE, 'identity' => 'gloskin-demo-r2-achiev-iama-2023', 'title' => 'Top Aesthetic Clinic West Java 2023', 'excerpt' => 'Diakui sebagai klinik estetika terkemuka di Jawa Barat oleh Indonesian Aesthetic Medicine Association.', 'meta' => array( 'gloskin_achievement_issuer' => 'Indonesian Aesthetic Medicine Association', 'gloskin_achievement_year' => '2023', 'gloskin_achievement_feature_on_home' => '1', 'gloskin_achievement_active' => '0', 'gloskin_achievement_order' => '2' ) ),
			array( 'type' => 'achievement', 'post_type' => Gloskin_Site_Core_Content_Service::ACHIEVEMENT_POST_TYPE, 'identity' => 'gloskin-demo-r2-achiev-kemenkes-2023', 'title' => 'Sertifikasi Standar Klinis Premium', 'excerpt' => 'Sertifikasi standar pelayanan medis tingkat premium dari Kementerian Kesehatan Republik Indonesia.', 'meta' => array( 'gloskin_achievement_issuer' => 'Kementerian Kesehatan Republik Indonesia', 'gloskin_achievement_year' => '2023', 'gloskin_achievement_feature_on_home' => '0', 'gloskin_achievement_active' => '0', 'gloskin_achievement_order' => '3' ) ),
		);
