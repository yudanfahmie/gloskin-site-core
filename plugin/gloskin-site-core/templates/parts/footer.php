...
<footer class="gloskin-ui1-footer">
	...
	<div class="gloskin-ui1-container gloskin-ui1-footer__grid">
		<div class="gloskin-ui1-footer__brand"><a class="gloskin-ui1-brand gloskin-ui1-brand--footer" href="<?php echo esc_url( home_url( '/' ) ); ?>">Gloskin</a><p><?php echo esc_html__( 'Gloskin adalah klinik estetika, anti-aging, dan perawatan rambut yang mengedepankan konsultasi dan penanganan dokter di setiap kliniknya.', 'gloskin-site-core' ); ?></p></div>
