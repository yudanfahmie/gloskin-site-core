...
if ( ! function_exists( 'gloskin_ui1_arrow_icon' ) ) {
	 ...
	 *
	 * The two path geometries are the approved Gloskin arrow resource. Color is
	 * intentionally inherited through currentColor; previous direction mirrors
	 * the same single geometry rather than maintaining a second icon variant.
	 *
	...
	function gloskin_ui1_arrow_icon( $direction = 'next' ) {
		...
		return '<svg class="' . esc_attr( $classes ) . '" viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg">'
