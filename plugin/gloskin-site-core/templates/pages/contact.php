...
<section class="gloskin-ui1-section">
	<div class="gloskin-ui1-container">
		...
		<?php gloskin_ui1_render_section_heading( __( 'Clinic contacts', 'gloskin-site-core' ) ); ?>
...
<section class="gloskin-ui1-section gloskin-ui1-section--soft">
	<div class="gloskin-ui1-container gloskin-ui1-container--narrow">
		...
		<div class="gloskin-ui1-form"><?php echo $gloskin_context['form_html']; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- trusted configured shortcode provider output. ?></div>
	</div>
</section>
