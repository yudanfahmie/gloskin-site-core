...
$gloskin_quick_auth_from_drawer = ! empty( $gloskin_commerce['quick_auth'] );
?>
<div class="gloskin-ui1-drawer" id="gloskin-mobile-drawer" data-gloskin-drawer aria-hidden="true" hidden>
	...
	<div class="gloskin-ui1-drawer__panel" role="dialog" aria-modal="true" aria-labelledby="gloskin-mobile-nav-title">
		<div class="gloskin-ui1-drawer__head"><span id="gloskin-mobile-nav-title" class="gloskin-ui1-drawer__brand"><?php gloskin_ui1_render_brand_logo( $gloskin_logo_url, 'gloskin-ui1-brand__image--drawer' ); ?></span><button class="gloskin-ui1-drawer__close" type="button" data-gloskin-drawer-close><span class="screen-reader-text"><?php echo esc_html__( 'Tutup navigasi', 'gloskin-site-core' ); ?></span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true" focusable="false"><path d="M4 4l10 10M14 4 4 14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg></button></div>
		<nav class="gloskin-ui1-nav gloskin-ui1-nav--mobile" aria-label="<?php echo esc_attr__( 'Navigasi seluler', 'gloskin-site-core' ); ?>"><?php gloskin_ui1_render_nav_tree( $gloskin_navigation, 'mobile' ); ?></nav>
		<?php if ( $gloskin_woo ) : ?>
		<div class="gloskin-ui1-drawer__utilities">
			<?php if ( ! empty( $gloskin_commerce['account_url'] ) ) : ?><a class="gloskin-ui1-drawer__utility-link" href="<?php echo esc_url( $gloskin_commerce['account_url'] ); ?>"<?php if ( $gloskin_quick_auth_from_drawer ) : ?> data-gloskin-auth-open-from-drawer<?php endif; ?>><svg width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true" focusable="false"><circle cx="10" cy="7.5" r="3.5" stroke="currentColor" stroke-width="1.4"/><path d="M3.5 17.5c0-3.3 2.9-6 6.5-6s6.5 2.7 6.5 6" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg><?php echo esc_html( is_user_logged_in() ? __( 'Akun saya', 'gloskin-site-core' ) : __( 'Masuk', 'gloskin-site-core' ) ); ?></a><?php endif; ?>
