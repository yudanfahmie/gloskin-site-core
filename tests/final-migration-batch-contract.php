...
/** Static contract: doctor photo batch processing and cursor-based resume for v0.7.150. */
...
ok_batch((bool)preg_match("/const VERSION\s*=\s*'0\.7\.150'/",$kernel),'Kernel VERSION must be 0.7.150');ok_batch((bool)preg_match('/^ \* Version: 0\.7\.150$/m',$plugin_h),'Plugin header Version must be 0.7.150');
