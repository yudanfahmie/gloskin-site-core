...
/** Static contract: doctor photo batch processing and cursor-based resume for v0.7.159. */
...
ok_batch((bool)preg_match("/const VERSION\s*=\s*'0\.7\.157'/",$kernel),'Kernel VERSION must be 0.7.159');ok_batch((bool)preg_match('/^ \* Version: 0\.7\.157$/m',$plugin_h),'Plugin header Version must be 0.7.159');
