...
<<<<<<< HEAD
/** Static contract: doctor photo batch processing and cursor-based resume for v0.7.155. */
=======
/** Static contract: doctor photo batch processing and cursor-based resume for v0.7.156. */
...
<<<<<<< HEAD
ok_batch((bool)preg_match("/const VERSION\s*=\s*'0\.7\.154'/",$kernel),'Kernel VERSION must be 0.7.155');ok_batch((bool)preg_match('/^ \* Version: 0\.7\.154$/m',$plugin_h),'Plugin header Version must be 0.7.155');
=======
ok_batch((bool)preg_match("/const VERSION\s*=\s*'0\.7\.156'/",$kernel),'Kernel VERSION must be 0.7.156');ok_batch((bool)preg_match('/^ \* Version: 0\.7\.156$/m',$plugin_h),'Plugin header Version must be 0.7.156');
>>>>>>> cd8b8a3e43a2fde30f37702b31ab3cea5f3a617b
