 ...
 *   15. Plugin / Kernel version synchronized at 0.7.142.
 */
...
/* 15. Version sync */
ok_batch( (bool) preg_match( "/const VERSION\s*=\s*'0\.7\.142'/", $kernel ), 'Kernel VERSION must be 0.7.142' );
ok_batch( (bool) preg_match( '/^ \* Version: 0\.7\.142$/m', $plugin_h ), 'Plugin header Version must be 0.7.142' );
