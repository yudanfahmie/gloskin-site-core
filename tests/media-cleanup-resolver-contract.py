...
require(
    "Version: 0.7.173" in plugin and "const VERSION = '0.7.173';" in kernel,
    "plugin and Kernel patch versions must be synchronized at 0.7.173"
)
print("media-cleanup-resolver-contract.py: OK (0.7.173)")
