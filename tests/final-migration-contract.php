...
/* $seen_shas dedup removed 0.7.152: manifest SHAs are unique by definition;
...
ok( (bool) preg_match( "/const VERSION\s*=\s*'0\.7\.152'/", $kernel ), 'Kernel VERSION must be 0.7.152' );
ok( (bool) preg_match( '/^ \* Version: 0\.7\.152$/m', $plugin_h ), 'Plugin header Version must be 0.7.152' );
