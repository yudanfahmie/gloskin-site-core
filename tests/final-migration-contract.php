...
/* $seen_shas dedup removed 0.7.151: manifest SHAs are unique by definition;
...
ok( (bool) preg_match( "/const VERSION\s*=\s*'0\.7\.151'/", $kernel ), 'Kernel VERSION must be 0.7.151' );
ok( (bool) preg_match( '/^ \* Version: 0\.7\.151$/m', $plugin_h ), 'Plugin header Version must be 0.7.151' );
