...
ok( (bool) preg_match( "/const VERSION\s*=\s*'0\.7\.142'/", $kernel ), 'Kernel VERSION must be 0.7.142' );
ok( (bool) preg_match( '/^ \* Version: 0\.7\.142$/m', $plugin_h ), 'Plugin header Version must be 0.7.142' );
