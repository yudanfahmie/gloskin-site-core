...
/* ── Version ─────────────────────────────────────────────────────── */
p5must( false !== strpos( $kernel, "const VERSION = '0.7.223'" ) && false !== strpos( $plugin, 'Version: 0.7.223' ), 'release owners synchronized at 0.7.223' );
...
echo "phase5-translation-frontend-contract.php: OK (native locale bridge + single resolver + cached registries + circuit breaker + structural Woo guard + content ownership + version 0.7.223)\n";
