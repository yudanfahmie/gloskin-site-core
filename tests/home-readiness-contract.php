...
home_must( false !== strpos( $kernel, "const VERSION = '0.7.197'" ) && false !== strpos( $bootstrap, 'Version: 0.7.197' ), 'release owners are synchronized at 0.7.197' );

echo "home-readiness-contract.php: OK (Home cover hero, Promo stacked carousel contract, footer CTA routes, version 0.7.197)\n";