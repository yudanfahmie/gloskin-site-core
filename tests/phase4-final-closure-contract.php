...
p4must( false !== strpos( $k, "const VERSION = '0.7.215'" ) && false !== strpos( $b, 'Version: 0.7.215' ), 'release owners synchronized at 0.7.215' );

echo "phase4-final-closure-contract.php: OK (73 canonical hard integrity + Home cover/video + Promo carousel JS-CSS contract + Promo arch durable + footer universal CTA + About static copy + bounded About continuation + Shop CSS dep + version 0.7.215)\n";
