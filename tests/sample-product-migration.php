...
$vars=0; foreach($v['products'] as $p){$vars+=count($p['variations']); ok(count($v['media_by_product'][$p['source_id']])===$p['media_count'],'media checkpoint');} ok($vars===10,'10 variations');
