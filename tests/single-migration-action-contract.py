...
Asserts:
  ...
  9.  Plugin / Kernel version synchronized at 0.7.161.
"""
...
require("Version: 0.7.161" in plugin_h, "plugin header must be 0.7.161")
require("const VERSION = '0.7.161';" in kernel, "Kernel VERSION must be 0.7.161")
...
print('single-migration-action-contract.py: OK (0.7.161)')
