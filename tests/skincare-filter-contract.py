...
Asserts:
  ...
  14. Plugin / Kernel version synchronized at 0.7.172.
"""
...
require("Version: 0.7.172" in plugin_h, "plugin header must be 0.7.172")
require("const VERSION = '0.7.172';" in kernel, "Kernel VERSION must be 0.7.172")
...
print('skincare-filter-contract.py: OK (0.7.172)')
